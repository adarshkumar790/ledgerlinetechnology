  ...
  return (
    <header className="flex items-center justify-between p-5 bg-black">
      ...
      <nav
        className={`${
          isOpen ? "flex" : "hidden"
        } md:flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 text-sm uppercase absolute md:static bg-slate-500 md:bg-transparent w-full md:w-auto top-16 left-0 md:top-auto md:left-auto px-5 md:px-0 py-5 md:py-0 z-10`}
      >
