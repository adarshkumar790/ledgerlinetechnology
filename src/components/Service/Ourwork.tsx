...
export default function Ourwork() {
  return (
    <div className="bg-black text-white min-h-screen flex items-center justify-center">
      <div className="max-w-5xl mx-auto p-6 md:mt-60 mt-20">
  ...
  {/* Our1 Image */}
  <div className="w-full flex justify-center -mt-20 hidden md:flex">
    <Image
      src="/our1.png"
  ...
  {/* Our2 Image */}
  <div className="w-full flex justify-center -mt-48 hidden md:flex">
    <Image
      src="/our2.png"
