        ...
        <div className="mt-8 md:mt-0 md:flex md:space-x-14 pl-9 sm:pl-0">
          ...
          <div>
            ...
            <ul className="space-y-2 mt-4 sm:mt-4">
              <li><a href="/service/#all" className="text-white">Blockchain Solutions</a></li>
              <li><a href="/service/#all" className="text-white">IT Management System</a></li>
              <li><a href="/service/#all" className="text-white">Web Development</a></li>
              <li><a href="/service/#all" className="text-white">App Development</a></li>
            </ul>
          </div>
        </div>
