      ...
      <div className="max-w-[900px] mx-auto px-4 md:flex md:justify-between md:items-start mt-20">
        <div>
          ...
          <div className="flex space-x-4 mt-4 ml-2">
            ...
            <a href="https://discord.com/channels/1335184709894017155/1335184709894017158" className="text-gray-400 hover:text-white">
              <Image
                src="/discords.png"
                alt="LinkedIn"
                width={35}
        ...
        <div className="mt-8 md:mt-0 md:flex md:space-x-14 pl-9 sm:pl-0">
          ...
          <div>
            ...
            <ul className="space-y-2 mt-4 sm:mt-4">
              <li><a href="/service/#blockchain" className="text-white">Blockchain Solutions</a></li>
              <li><a href="/blog/#itmanagement" className="text-white">IT Management System</a></li>
              <li><a href="/blog/#web" className="text-white">Web Development</a></li>
              <li><a href="/blog/#app" className="text-white">App Development</a></li>
            </ul>
          </div>
        </div>
