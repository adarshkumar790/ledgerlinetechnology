  ...
  return (
    <div className="bg-black min-h-screen flex flex-col text-white">
      ...
      <div className="relative py-6 md:ml-4">
        ...
        <div className="absolute top-0 left-[34.5%] z-10 h-full w-[2px] bg-[#83868A] transform -translate-x-1/2 md:hidden"></div>
        ...
        <div className="flex md:flex-row flex-col  items-center justify-center space-y-4 md:space-y-0 md:space-x-20">
          {categories.map((category, index) => (
            ...
            >
              {/* Circle */}
              <div
                className={`w-6 h-6 border-2 rounded-full -ml-32 md:-ml-0  flex items-center justify-center relative ${
